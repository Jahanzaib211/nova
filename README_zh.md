...
Nova 是 DeerFlow 2.0 的全栈重构——**698 个新文件、120,533 行全新代码**，总变更为 **1,148 个文件，+145,947 / −11,844**。分叉点处的 1,338 个上游文件中，884 个（66%）未被改动。审计日期 2026-09-08；所有数字均可复现，完整命令（含哪些生成产物被排除及其原因）见 **[NOVA_VS_DEERFLOW.md](./NOVA_VS_DEERFLOW.md)**。
