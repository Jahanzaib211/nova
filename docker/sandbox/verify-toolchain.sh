...
CHECKS=(
    ...
    "wifite:wifite --version | head -1"
    "suricata:suricata --build-info | head -1"
    "yara:yara --version"
    "sleuthkit:fls -V"
    "secretsdump.py:secretsdump.py --help | head -1"
    "sherlock:sherlock --help | head -1"
    "theHarvester:theHarvester --help | head -1"
    "arjun:arjun --version"
