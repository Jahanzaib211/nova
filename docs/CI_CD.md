...
|---|---|---|
| `backend-unit-tests.yml` | push/PR to main | 7,040 backend unit tests (`make test`) — 418 backend test files (266 upstream + 152 Nova) |
| `backend-blocking-io-tests.yml` | push/PR to main | Blockbuster runtime gate on async blocking IO |
| `frontend-unit-tests.yml` | push/PR to main | 751 frontend unit tests (`pnpm test`) |
...
|---|---|---|---|
| Backend unit tests | 7,040 | `cd backend && make test` | 2026-09-19 |
| Frontend unit tests | 751 | `cd frontend && pnpm test` | 2026-09-19 |
