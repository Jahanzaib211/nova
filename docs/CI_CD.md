...
|---|---|---|
| `backend-unit-tests.yml` | push/PR to main | 7,179 backend unit tests (`make test`) — 418 backend test files (266 upstream + 152 Nova) |
...
|---|---|---|---|
| Backend unit tests | 7,179 | `cd backend && make test` | 2026-09-19 |
