...
Project-level documentation for Nova.
...
| `audit/README.md` | Audit directory index |
| `images/` | Documentation images |

## Also see

- `backend/docs/` — backend-specific docs
- `frontend/CLAUDE.md` — frontend project rules
- `AGENTS.md` — cross-project AI agent rules
