  ...
  return (
    <AIElementMessage
      className={cn(
        ...
        // While the assistant turn is streaming, glow the active message with the
        // same shine the subagent cards use — so the chat feels alive while the
        // heavy work streams in the Agent's Computer.
        isLoading && !isHuman && "rounded-xl",
        className,
      )}
